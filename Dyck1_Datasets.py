...
class NextTokenPrediction2TokenDataset(Dataset):
    def __init__(self):
        # xy = np.loadtxt('Dyck1_Dataset_Suzgun_train_.txt', delimiter=",")
        # self.x = torch.from_numpy(xy[:,0])
        # self.y = torch.from_numpy(xy[:, [1]])
        ...
        self.lengths = []
        # self.n_samples = xy.shape[0]
        with open('Dyck1_Dataset_Suzgun_2tokens.txt', 'r') as f:
            for line in f:
                line = line.split(",")
                sentence = line[0].strip()
                label = line[1].strip()
...
class NextTokenPrediction2and4TokenDataset(Dataset):
    def __init__(self):
        # xy = np.loadtxt('Dyck1_Dataset_Suzgun_train_.txt', delimiter=",")
        # self.x = torch.from_numpy(xy[:,0])
        # self.y = torch.from_numpy(xy[:, [1]])
        ...
        self.lengths = []
        # self.n_samples = xy.shape[0]
        with open('Dyck1_Dataset_Suzgun_2to4tokens.txt', 'r') as f:
            for line in f:
                line = line.split(",")
                sentence = line[0].strip()
                label = line[1].strip()
...
class NextTokenPrediction2TokenPlusDataset(Dataset):
    def __init__(self):
        # xy = np.loadtxt('Dyck1_Dataset_Suzgun_train_.txt', delimiter=",")
        # self.x = torch.from_numpy(xy[:,0])
        # self.y = torch.from_numpy(xy[:, [1]])
...
class NextTokenPrediction1to2TokenDataset(Dataset):
    def __init__(self):
        # xy = np.loadtxt('Dyck1_Dataset_Suzgun_train_.txt', delimiter=",")
        # self.x = torch.from_numpy(xy[:,0])
        # self.y = torch.from_numpy(xy[:, [1]])
        ...
        self.lengths = []
        # self.n_samples = xy.shape[0]
        with open('Dyck1_Dataset_Suzgun_1to2tokens.txt', 'r') as f:
            for line in f:
                line = line.split(",")
                sentence = line[0].strip()
                label = line[1].strip()
